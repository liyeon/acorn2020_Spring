...
<div class="container mt-4">
	<a href="private/insertform.do" class="btn btn-warning mb-4">새글 작성</a>
	<h1>글 목록 입니다.</h1>
	...
	<div class="input-group">
		<div class="input-group-prepend">
			<label for="condition" class="input-group-text">검색조건</label>
		...
		<input value="${keyword }" class="form-control" type="text" name="keyword" placeholder="검색어를 입력해주세요!!"/>
